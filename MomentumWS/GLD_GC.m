...
gc=load('inputData_GC_1600_20100802', 'tday', 'cl'); 
...
% ret=(gld.cl-lag(gld.cl, 1))./lag(gld.cl, 1)-...
%     (gc.cl-lag(gc.cl, 1))./lag(gc.cl, 1);

ret=(gld.cl-backshift(1, gld.cl))./backshift(1, gld.cl)-...
    (gc.cl-backshift(1, gc.cl))./backshift(1, gc.cl);
...
fprintf(1, 'Avg Ann Ret=%7.4f Sharpe ratio=%4.2f \n',252*mean(ret, 'omitnan'), sqrt(252)*mean(ret-riskFreeRate, 'omitnan')/std(ret-riskFreeRate, 'omitnan'));
