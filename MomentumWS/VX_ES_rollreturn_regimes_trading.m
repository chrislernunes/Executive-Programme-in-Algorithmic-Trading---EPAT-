...
for c=1:length(contracts)
    ...
    if (~isempty(expireIdx))
        ...
        positions(idx(dailyRoll > entryThreshold), c)=1*0.315377;
...
% Use same hedge ratio 0.35 for contango or backwardation
% APR=0.094186 Sharpe=0.963579
% maxDD=-0.103825 maxDDD=273
% 
% Use different hedge ratios for contango vs backwardation
% APR=0.085122 Sharpe=0.816603
% maxDD=-0.135060 maxDDD=277

% Use hedge ratio 0.315377
% APR=0.082506 Sharpe=0.811878
% maxDD=-0.119421 maxDDD=321
