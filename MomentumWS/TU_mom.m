...
% longs=backshift(25, cl) > backshift(lookback, cl)  ;
% shorts=backshift(25, cl) < backshift(lookback, cl) ;
...
fprintf(1, 'Avg Ann Ret=%7.4f Ann Volatility=%7.4f Sharpe ratio=%4.2f \n',252*smartmean(ret), sqrt(252)*smartstd(ret), sqrt(252)*smartmean(ret)/smartstd(ret));
