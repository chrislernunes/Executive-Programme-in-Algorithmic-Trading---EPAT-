...
[num txt]=xlsread('USO.csv');

cl=num(:, end);
tday=str2double(cellstr(datestr(datenum(txt(2:end, 1), 'mm/dd/yyyy'), 'yyyymmdd')));
...
% tday > 20080501 & tday < 20110228
% APR=0.117600 Sharpe=1.100368 with Cl
% APR=0.074901 Sharpe=0.575200 with USO

%  tday >= 20110228
% APR=0.029504 Sharpe=0.326068 with USO
